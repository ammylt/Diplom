...
export const Test1Task6 = () => {
    return (
        <div>
            <span className="h_1">6 Задание.</span>
            <br className="br_2"/>
            Минимизируйте функцию из п. 3 методом Карно. Найдите тупиковую ДНФ, тупиковую КНФ. Рекомендуется использовать следующую разметку карты Карно.
            <br />
            <MapCarno />
            <br />
